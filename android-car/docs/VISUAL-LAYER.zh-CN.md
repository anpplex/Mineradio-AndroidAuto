...
播放页常驻：☰ / 模式三段 / 主播控 /（舞台可选 FX 入口）。  
不常驻：搜索条与源 tab、DIY 色值 chip、分析 chip、扫码大 CTA（仅空首页）、Showcase 长文案。
...
| **右下 BR** | `#plugin-fab` 安装/扩展插件 | **72×72** | 右 **20**；底 **safe-bottom+12** | 安装插件入口 |
| **底栏** | Mac 式播控（封面·臻音·心·传输·词·音量·调声·时间） | 热区 **64** / 播停 **76** | 底 **safe-bottom** | 藏睡眠/全沉浸/全屏等低频 |
