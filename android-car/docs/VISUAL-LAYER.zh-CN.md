...
### 1.3 角区功能块规范（左上 / 右上 / 右下）

| 区 | 控件 | 尺寸 | 边距 | 字/图 |
| --- | --- | --- | --- | --- |
| **左上 TL** | `#playlist-toggle` 歌单 | **72×72** 圆 | 顶/左 **20** | 图标 **30** |
| **右上 TR** | `#home-btn` Home；（空首页）`#car-login-entry` | Home **72**；登录高 **72** 胶囊 | 顶/右 **20**；控件间距 **12** | 登录字 **18** / 700 |
| **右下 BR** | `#fx-fab` 视觉控制台 | **72×72** 圆 | 右 **20**；底 = 底栏高 + **12** 间隙 | 图标 **30** |
| **左下 BL**（对照） | 行车/巡航/舞台 | 段高 **72**，段宽 ≥**76** | 左 **20**；底与 FX 同高 | 字 **18** / 700 |

材质统一 Windows 玻璃：`var(--car-panel-strong)` + 1px 白边 + 阴影；**禁止**角区混用手机 44/48 幽灵按钮。
